...
namespace PatientHanteringWPF.MVVM.CloseWindows
{
    public class WindowCloser
    {
        ...
        public static readonly DependencyProperty EnableWindowClosingProperty =
            DependencyProperty.RegisterAttached("EnableWindowClosing", typeof(bool), typeof(WindowCloser), new PropertyMetadata(false, OnEneableWindowClosingChanged));

        private static void OnEneableWindowClosingChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
